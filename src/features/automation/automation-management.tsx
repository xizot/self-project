...
import AutomationForm from '@/src/features/automation/automation-form';
import ScriptForm from '@/src/features/automation/script-form';
import { AutomationScript, AutomationTask } from '@/src/lib/types';
...
import { Clock, Edit, FileCode, Play, Search, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => setShowScriptsDialog(true)}>
      ...
      <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {filteredTasks.map((task) => (
          <Card
            key={task.id}
            className="hover:shadow-md transition-shadow py-1 gap-2"
          >
      ...
      <Dialog open={showScriptsDialog} onOpenChange={setShowScriptsDialog}>
        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
          ...
          <ScriptsList scripts={scripts} onRefresh={fetchScripts} />
        </DialogContent>
      </Dialog>
    </div>
  );
